    ...
    return (
      <div className="view-results-wrapper">
        ...
        {this.state.quiz && this.state.result && (
          <div className="body">
            <div className="header">Test Natijalari</div>
            <div className="quiz-data">
              <div className="left">
                <div className="header">{this.state.quiz.name}</div>
                <div className="category">{this.state.quiz.category}</div>
                <div className="comments">
                  {this.state.quiz.comments.length} Izohlar
                </div>
              </div>
              <div className="right">
                <div className="likes">{this.state.quiz.likes} Likes</div>
                <div className="others">
                  Jami {this.state.quiz.scores.length} marta ishlangan
                </div>
              </div>
            </div>

            <div className="score">Natija: {this.getScore()}</div>
            ...
            <div className="answers">
              {this.state.quiz.questions.map((q, idx) => (
                <div
                  key={idx}
                  className="answer"
                  style={{ borderLeft: this.getBorderLeft(idx) }}
                >
